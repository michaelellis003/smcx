...
from .linalg import norm as matrix_norm
...
def device_info(d: Device | None = None) -> dict[str, str | int]:
    """
...
def new_thread_unsafe_stream(device: Device) -> Stream:
    """
...
def new_thread_local_stream(device: Device) -> ThreadLocalStream:
...
class StreamContext:
    ...
    def __init__(self, s: Stream | ThreadLocalStream | Device) -> None: ...

    def __enter__(self) -> None: ...

    def __exit__(self, exc_type: type | None = None, exc_value: object | None = None, traceback: object | None = None) -> None: ...

def stream(s: Stream | ThreadLocalStream | Device) -> StreamContext:
    """
...
def synchronize(stream: Stream | ThreadLocalStream | Device | None = None) -> None:
    """
...
class ArrayAt:
    ...
    def add(self, value: bool | int | float | array | Annotated[NDArray, dict(writable=False)] | complex | ArrayLike) -> array: ...

    def subtract(self, value: bool | int | float | array | Annotated[NDArray, dict(writable=False)] | complex | ArrayLike) -> array: ...

    def multiply(self, value: bool | int | float | array | Annotated[NDArray, dict(writable=False)] | complex | ArrayLike) -> array: ...

    def divide(self, value: bool | int | float | array | Annotated[NDArray, dict(writable=False)] | complex | ArrayLike) -> array: ...

    def maximum(self, value: bool | int | float | array | Annotated[NDArray, dict(writable=False)] | complex | ArrayLike) -> array: ...

    def minimum(self, value: bool | int | float | array | Annotated[NDArray, dict(writable=False)] | complex | ArrayLike) -> array: ...
...
class array:
    ...
    def astype(self, dtype: Dtype, stream: Stream | ThreadLocalStream | Device | None = None) -> array:
        """
    ...
    def __setitem__(self, arg0: object | None, arg1: bool | int | float | array | Annotated[NDArray, dict(writable=False)] | complex | ArrayLike) -> None: ...
    ...
    def __dlpack__(self, *, stream: object | None = None, max_version: object | None = None, dl_device: tuple[int, int] | None = None, copy: bool | None = None) -> NDArray: ...
    ...
    def __add__(self, other: bool | int | float | array | Annotated[NDArray, dict(writable=False)] | complex | ArrayLike) -> array: ...

    def __iadd__(self, other: bool | int | float | array | Annotated[NDArray, dict(writable=False)] | complex | ArrayLike) -> array: ...

    def __radd__(self, other: bool | int | float | array | Annotated[NDArray, dict(writable=False)] | complex | ArrayLike) -> array: ...

    def __sub__(self, other: bool | int | float | array | Annotated[NDArray, dict(writable=False)] | complex | ArrayLike) -> array: ...

    def __isub__(self, other: bool | int | float | array | Annotated[NDArray, dict(writable=False)] | complex | ArrayLike) -> array: ...

    def __rsub__(self, other: bool | int | float | array | Annotated[NDArray, dict(writable=False)] | complex | ArrayLike) -> array: ...

    def __mul__(self, other: bool | int | float | array | Annotated[NDArray, dict(writable=False)] | complex | ArrayLike) -> array: ...

    def __imul__(self, other: bool | int | float | array | Annotated[NDArray, dict(writable=False)] | complex | ArrayLike) -> array: ...

    def __rmul__(self, other: bool | int | float | array | Annotated[NDArray, dict(writable=False)] | complex | ArrayLike) -> array: ...

    def __truediv__(self, other: bool | int | float | array | Annotated[NDArray, dict(writable=False)] | complex | ArrayLike) -> array: ...

    def __itruediv__(self, other: bool | int | float | array | Annotated[NDArray, dict(writable=False)] | complex | ArrayLike) -> array: ...

    def __rtruediv__(self, other: bool | int | float | array | Annotated[NDArray, dict(writable=False)] | complex | ArrayLike) -> array: ...

    def __div__(self, other: bool | int | float | array | Annotated[NDArray, dict(writable=False)] | complex | ArrayLike) -> array: ...

    def __rdiv__(self, other: bool | int | float | array | Annotated[NDArray, dict(writable=False)] | complex | ArrayLike) -> array: ...

    def __floordiv__(self, other: bool | int | float | array | Annotated[NDArray, dict(writable=False)] | complex | ArrayLike) -> array: ...

    def __ifloordiv__(self, other: bool | int | float | array | Annotated[NDArray, dict(writable=False)] | complex | ArrayLike) -> array: ...

    def __rfloordiv__(self, other: bool | int | float | array | Annotated[NDArray, dict(writable=False)] | complex | ArrayLike) -> array: ...

    def __mod__(self, other: bool | int | float | array | Annotated[NDArray, dict(writable=False)] | complex | ArrayLike) -> array: ...

    def __imod__(self, other: bool | int | float | array | Annotated[NDArray, dict(writable=False)] | complex | ArrayLike) -> array: ...

    def __rmod__(self, other: bool | int | float | array | Annotated[NDArray, dict(writable=False)] | complex | ArrayLike) -> array: ...

    def __eq__(self, other: bool | int | float | array | Annotated[NDArray, dict(writable=False)] | complex | ArrayLike) -> array | bool: ...

    def __lt__(self, other: bool | int | float | array | Annotated[NDArray, dict(writable=False)] | complex | ArrayLike) -> array: ...

    def __le__(self, other: bool | int | float | array | Annotated[NDArray, dict(writable=False)] | complex | ArrayLike) -> array: ...

    def __gt__(self, other: bool | int | float | array | Annotated[NDArray, dict(writable=False)] | complex | ArrayLike) -> array: ...

    def __ge__(self, other: bool | int | float | array | Annotated[NDArray, dict(writable=False)] | complex | ArrayLike) -> array: ...

    def __ne__(self, other: bool | int | float | array | Annotated[NDArray, dict(writable=False)] | complex | ArrayLike) -> array | bool: ...
    ...
    def __pow__(self, other: bool | int | float | array | Annotated[NDArray, dict(writable=False)] | complex | ArrayLike) -> array: ...

    def __rpow__(self, other: bool | int | float | array | Annotated[NDArray, dict(writable=False)] | complex | ArrayLike) -> array: ...

    def __ipow__(self, other: bool | int | float | array | Annotated[NDArray, dict(writable=False)] | complex | ArrayLike) -> array: ...

    def __invert__(self) -> array: ...

    def __and__(self, other: bool | int | float | array | Annotated[NDArray, dict(writable=False)] | complex | ArrayLike) -> array: ...

    def __iand__(self, other: bool | int | float | array | Annotated[NDArray, dict(writable=False)] | complex | ArrayLike) -> array: ...

    def __or__(self, other: bool | int | float | array | Annotated[NDArray, dict(writable=False)] | complex | ArrayLike) -> array: ...

    def __ior__(self, other: bool | int | float | array | Annotated[NDArray, dict(writable=False)] | complex | ArrayLike) -> array: ...

    def __lshift__(self, other: bool | int | float | array | Annotated[NDArray, dict(writable=False)] | complex | ArrayLike) -> array: ...

    def __ilshift__(self, other: bool | int | float | array | Annotated[NDArray, dict(writable=False)] | complex | ArrayLike) -> array: ...

    def __rshift__(self, other: bool | int | float | array | Annotated[NDArray, dict(writable=False)] | complex | ArrayLike) -> array: ...

    def __irshift__(self, other: bool | int | float | array | Annotated[NDArray, dict(writable=False)] | complex | ArrayLike) -> array: ...

    def __xor__(self, other: bool | int | float | array | Annotated[NDArray, dict(writable=False)] | complex | ArrayLike) -> array: ...

    def __ixor__(self, other: bool | int | float | array | Annotated[NDArray, dict(writable=False)] | complex | ArrayLike) -> array: ...

    def __int__(self) -> int: ...

    def __float__(self) -> float: ...

    def flatten(self, start_axis: int = 0, end_axis: int = -1, *, stream: Stream | ThreadLocalStream | Device | None = None) -> array:
        """See :func:`flatten`."""

    def reshape(self, *shape, stream: Stream | ThreadLocalStream | Device | None = None) -> array:
        """
    ...
    def squeeze(self, axis: int | Sequence[int] | None = None, *, stream: Stream | ThreadLocalStream | Device | None = None) -> array:
        """See :func:`squeeze`."""

    def abs(self, *, stream: Stream | ThreadLocalStream | Device | None = None) -> array:
        """See :func:`abs`."""

    def __abs__(self) -> array:
        """See :func:`abs`."""

    def square(self, *, stream: Stream | ThreadLocalStream | Device | None = None) -> array:
        """See :func:`square`."""

    def sqrt(self, *, stream: Stream | ThreadLocalStream | Device | None = None) -> array:
        """See :func:`sqrt`."""

    def rsqrt(self, *, stream: Stream | ThreadLocalStream | Device | None = None) -> array:
        """See :func:`rsqrt`."""

    def reciprocal(self, *, stream: Stream | ThreadLocalStream | Device | None = None) -> array:
        """See :func:`reciprocal`."""

    def exp(self, *, stream: Stream | ThreadLocalStream | Device | None = None) -> array:
        """See :func:`exp`."""

    def log(self, *, stream: Stream | ThreadLocalStream | Device | None = None) -> array:
        """See :func:`log`."""

    def log2(self, *, stream: Stream | ThreadLocalStream | Device | None = None) -> array:
        """See :func:`log2`."""

    def log10(self, *, stream: Stream | ThreadLocalStream | Device | None = None) -> array:
        """See :func:`log10`."""

    def sin(self, *, stream: Stream | ThreadLocalStream | Device | None = None) -> array:
        """See :func:`sin`."""

    def cos(self, *, stream: Stream | ThreadLocalStream | Device | None = None) -> array:
        """See :func:`cos`."""

    def log1p(self, *, stream: Stream | ThreadLocalStream | Device | None = None) -> array:
        """See :func:`log1p`."""

    def all(self, axis: int | Sequence[int] | None = None, keepdims: bool = False, *, stream: Stream | ThreadLocalStream | Device | None = None) -> array:
        """See :func:`all`."""

    def any(self, axis: int | Sequence[int] | None = None, keepdims: bool = False, *, stream: Stream | ThreadLocalStream | Device | None = None) -> array:
        """See :func:`any`."""

    def moveaxis(self, source: int, destination: int, *, stream: Stream | ThreadLocalStream | Device | None = None) -> array:
        """See :func:`moveaxis`."""

    def swapaxes(self, axis1: int, axis2: int, *, stream: Stream | ThreadLocalStream | Device | None = None) -> array:
        """See :func:`swapaxes`."""

    def transpose(self, *axes, stream: Stream | ThreadLocalStream | Device | None = None) -> array:
        """
    ...
    def sum(self, axis: int | Sequence[int] | None = None, keepdims: bool = False, *, stream: Stream | ThreadLocalStream | Device | None = None) -> array:
        """See :func:`sum`."""

    def prod(self, axis: int | Sequence[int] | None = None, keepdims: bool = False, *, stream: Stream | ThreadLocalStream | Device | None = None) -> array:
        """See :func:`prod`."""

    def min(self, axis: int | Sequence[int] | None = None, keepdims: bool = False, *, stream: Stream | ThreadLocalStream | Device | None = None) -> array:
        """See :func:`min`."""

    def max(self, axis: int | Sequence[int] | None = None, keepdims: bool = False, *, stream: Stream | ThreadLocalStream | Device | None = None) -> array:
        """See :func:`max`."""

    def logcumsumexp(self, axis: int | None = None, *, reverse: bool = False, inclusive: bool = True, stream: Stream | ThreadLocalStream | Device | None = None) -> array:
        """See :func:`logcumsumexp`."""

    def logsumexp(self, axis: int | Sequence[int] | None = None, keepdims: bool = False, *, stream: Stream | ThreadLocalStream | Device | None = None) -> array:
        """See :func:`logsumexp`."""

    def mean(self, axis: int | Sequence[int] | None = None, keepdims: bool = False, *, stream: Stream | ThreadLocalStream | Device | None = None) -> array:
        """See :func:`mean`."""

    def std(self, axis: int | Sequence[int] | None = None, keepdims: bool = False, ddof: int = 0, *, stream: Stream | ThreadLocalStream | Device | None = None) -> array:
        """See :func:`std`."""

    def var(self, axis: int | Sequence[int] | None = None, keepdims: bool = False, ddof: int = 0, *, stream: Stream | ThreadLocalStream | Device | None = None) -> array:
        """See :func:`var`."""

    def split(self, indices_or_sections: int | tuple[int, ...], axis: int = 0, *, stream: Stream | ThreadLocalStream | Device | None = None) -> list[array]:
        """See :func:`split`."""

    def argmin(self, axis: int | None = None, keepdims: bool = False, *, stream: Stream | ThreadLocalStream | Device | None = None) -> array:
        """See :func:`argmin`."""

    def argmax(self, axis: int | None = None, keepdims: bool = False, *, stream: Stream | ThreadLocalStream | Device | None = None) -> array:
        """See :func:`argmax`."""

    def cumsum(self, axis: int | None = None, *, reverse: bool = False, inclusive: bool = True, stream: Stream | ThreadLocalStream | Device | None = None) -> array:
        """See :func:`cumsum`."""

    def cumprod(self, axis: int | None = None, *, reverse: bool = False, inclusive: bool = True, stream: Stream | ThreadLocalStream | Device | None = None) -> array:
        """See :func:`cumprod`."""

    def cummax(self, axis: int | None = None, *, reverse: bool = False, inclusive: bool = True, stream: Stream | ThreadLocalStream | Device | None = None) -> array:
        """See :func:`cummax`."""

    def cummin(self, axis: int | None = None, *, reverse: bool = False, inclusive: bool = True, stream: Stream | ThreadLocalStream | Device | None = None) -> array:
        """See :func:`cummin`."""

    def round(self, decimals: int = 0, *, stream: Stream | ThreadLocalStream | Device | None = None) -> array:
        """See :func:`round`."""

    def diagonal(self, offset: int = 0, axis1: int = 0, axis2: int = 1, stream: Stream | ThreadLocalStream | Device | None = None) -> array:
        """See :func:`diagonal`."""

    def diag(self, k: int = 0, *, stream: Stream | ThreadLocalStream | Device | None = None) -> array:
        """Extract a diagonal or construct a diagonal matrix."""

    def conj(self, *, stream: Stream | ThreadLocalStream | Device | None = None) -> array:
        """See :func:`conj`."""

    def view(self, dtype: Dtype, *, stream: Stream | ThreadLocalStream | Device | None = None) -> array:
        """See :func:`view`."""
...
def flip(a: array, /, axis: Union[None, int, Sequence[int]] = None, *, stream: Union[None, Stream, Device] = None) -> array:
    """
...
def unstack(x: array, /, *, axis: int = 0, stream: Union[None, Stream, Device] = None) -> list[array]:
    """
...
def bartlett(M: int, *, stream: Stream | ThreadLocalStream | Device | None = None) -> array:
    r"""
...
def hanning(M: int, *, stream: Stream | ThreadLocalStream | Device | None = None) -> array:
    r"""
...
def asarray(a: Union[scalar, array, Sequence, DLPackCompatible], dtype: Optional[Dtype] = None, *, copy: Optional[bool] = None) -> array:
    """
...
def can_cast(from_: Union[array, Dtype], to: Dtype) -> bool:
    """
...
def set_printoptions(precision: int = -1) -> None:
    """
...
def get_printoptions() -> PrintOptions:
    """
...
def printoptions(precision: int = -1) -> _PrintOptionsContext:
    """
