...
smcx implements this ladder end to end — the
[README](https://github.com/michaelellis003/smcx#a-short-tour-of-sequential-inference)
tells the story with references.
