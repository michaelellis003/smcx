...
$O(N \log N)$ complexity are unchanged. Translations that expose subnormal
float32 spacings and exact finite-versus-infinity classification near the
overflow midpoint remain tracked in
